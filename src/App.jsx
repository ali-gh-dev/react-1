                        ...
                        <ul className="list-reset">
                            <li className="relative flex items-center justify-between px-2 py-6 border-b">
                                <div>
                                    ...
                                    <p className="inline-block mt-1 ml-2 text-gray-600">Tailwind CSS To DO App List
                                        1</p>
                                </div>
                            ...
                            <li className="relative flex items-center justify-between px-2 py-6 border-b">
                                <div>
                                    ...
                                    <p className="inline-block mt-1 ml-2 text-gray-600 line-through">Tailwind CSS To DO
                                        App
                                        List 2</p>
                                </div>
                                <button type="button" className="absolute right-0 flex items-center  space-x-1">
